...
SELECT NOW(), NOW(), CONCAT('Event content ', num), DATE_ADD(NOW(), INTERVAL num DAY), num * 100, CONCAT('#hashtag', num), num * 2, DATE_ADD(NOW(), INTERVAL num-1 DAY), DATE_ADD(NOW(), INTERVAL num DAY),
'OPEN', CONCAT('Event summary ', num), CONCAT('Event title ', num), CONCAT('tag', num)
FROM (
